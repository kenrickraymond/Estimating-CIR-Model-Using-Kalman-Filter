...
- [PDF](https://github.com/kenrickraymond/Estimating-CIR-Model-Using-Kalman-Filter/blob/main/Affine_Term_Structure_Model_Kalman_Filter.pdf): The PDF that explains the methodology and presents the results of the estimation using the Kalman filter.
